...
public class AddToProjectDialog : Window
{
    ...
    {
        Title = $"Dodaj '{component.Sku}' na projekt";
        ...
        {
            Text = $"Komponenta: {component.Sku} — {component.Description}",
        ...
        stack.Children.Add(Lbl("Projekt *"));
    ...
    private void Save_Click(object s, RoutedEventArgs e)
    {
        ...
        { MessageBox.Show("Izberi projekt.", "Napaka", MessageBoxButton.OK, MessageBoxImage.Warning); return; }
